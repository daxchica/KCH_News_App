...
class MiamiMundo extends StatefulWidget {
  const MiamiMundo({Key? key}) : super(key: key);

  @override
  _MiamiMundoState createState() => _MiamiMundoState();
}

class _MiamiMundoState extends State<MiamiMundo> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://miamimundo.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/seccion/destacados/')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper
            .getElement('a.elementor-post__thumbnail__link', ['href']);
