...
class LasAmericas extends StatefulWidget {
  const LasAmericas({Key? key}) : super(key: key);

  @override
  _LasAmericasState createState() => _LasAmericasState();
}

class _LasAmericasState extends State<LasAmericas> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://diariolasamericas.com');
      ...
      home: Row(
        children: [
          ...
          Flexible(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('Diario Las Americas'),
              ),
              body: SafeArea(
