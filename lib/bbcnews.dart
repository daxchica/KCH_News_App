...
class _BbcNewsState extends State<BbcNews> {
  ...
  final webScraper = WebScraper('https://www.https://www.bbc.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/mundo')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper
            .getElement('div>section[]>div[]>ul>li[]>div>div[]>h3>a', ['href']);
      ...
      home: Row(
        children: [
          ...
          Flexible(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('BBC Radio News'),
                leading: IconButton(
