...
class AsambleaEcu extends StatefulWidget {
  const AsambleaEcu({Key? key}) : super(key: key);

  @override
  _AsambleaEcuState createState() => _AsambleaEcuState();
}

class _AsambleaEcuState extends State<AsambleaEcu> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.asambleanacional.gob.ec');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/es/noticias/boletines-de-prensa')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper.getElement('h5 > a', ['href']);
      ...
      home: Row(
        children: [
          ...
          Flexible(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('Noticias Asamblea Ecuador'),
              ),
              body: SafeArea(
