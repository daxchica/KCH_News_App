...
class DiarioAs extends StatefulWidget {
  const DiarioAs({Key? key}) : super(key: key);

  @override
  _DiarioAsState createState() => _DiarioAsState();
}

class _DiarioAsState extends State<DiarioAs> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.as.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/diarioas/ecuador.html')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper.getElement('h2.title > a', ['href']);

        // productDescriptions = webScraper.getElement('h2.title > a', ['href']);
      });
    }
  }
