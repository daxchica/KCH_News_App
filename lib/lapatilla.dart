...
class LaPatilla extends StatefulWidget {
  const LaPatilla({Key? key}) : super(key: key);

  @override
  _LaPatillaState createState() => _LaPatillaState();
}

class _LaPatillaState extends State<LaPatilla> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://lapatilla.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/secciones/internacionales/')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper.getElement('a.read-more', ['href']);

        // productDescriptions = webScraper.getElement('h4', ['class']);
      });
    }
  }
      ...
      home: Row(
        children: [
          ...
          Flexible(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('La Patilla News'),
              ),
              body: SafeArea(
