...
class LaBotana extends StatefulWidget {
  const LaBotana({Key? key}) : super(key: key);

  @override
  _LaBotanaState createState() => _LaBotanaState();
}

class _LaBotanaState extends State<LaBotana> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.labotana.com');
      ...
      home: Row(
        children: [
          ...
          Flexible(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('La Botana News'),
              ),
              body: SafeArea(
