...
import 'package:kch_news_app/rfi.dart';
...
class Infobae extends StatefulWidget {
  const Infobae({Key? key}) : super(key: key);

  @override
  _InfobaeState createState() => _InfobaeState();
}

class _InfobaeState extends State<Infobae> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.infobae.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/ultimas-noticias-america/')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper.getElement('a.nd-feed-list-card', ['href']);

        // productDescriptions = webScraper
        //     .getElement('div.fusion-app >div.article-right-rail > div.content-section > div.section > article.article > div.nd-feed-list-wrapper > div.nd-feed-load-container-0 > a', ['class']);
      });
    }
  }
