...
class ElUniverso extends StatefulWidget {
  const ElUniverso({Key? key}) : super(key: key);

  @override
  _ElUniversoState createState() => _ElUniversoState();
}

class _ElUniversoState extends State<ElUniverso> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.eluniverso.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/ultimas-noticias/')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper
            .getElement('div.card-content.\\|.space-y-1 > h2 > a', ['href']);

        // productDescriptions = webScraper
        //     .getElement('div.card-content.\\|.space-y-1 > h2 > a', ['class']);
      });
    }
  }
