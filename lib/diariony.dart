...
class DiarioNy extends StatefulWidget {
  const DiarioNy({Key? key}) : super(key: key);

  @override
  _DiarioNyState createState() => _DiarioNyState();
}

class _DiarioNyState extends State<DiarioNy> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.eldiariony.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/categoria/noticias/')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper.getElement('h2 > a', ['href']);
