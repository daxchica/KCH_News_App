...
class Excelsior extends StatefulWidget {
  const Excelsior({Key? key}) : super(key: key);

  @override
  _ExcelsiorState createState() => _ExcelsiorState();
}

class _ExcelsiorState extends State<Excelsior> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.excelsior.com.mx');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/ultima-hora')) {
      setState(
        () {
          // getElement takes the address of html tag/element and attributes you want to scrap from website
          // it will return the attributes in the same order passed
          productNames = webScraper.getElement('a.media', ['href']);
        },
      );
    }
  }
      ...
      home: Row(
        children: [
          ...
          Flexible(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('Excelsior News'),
              ),
              body: SafeArea(
