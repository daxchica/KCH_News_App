...
class ElComercio extends StatefulWidget {
  const ElComercio({Key? key}) : super(key: key);

  @override
  _ElComercioState createState() => _ElComercioState();
}

class _ElComercioState extends State<ElComercio> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.elcomercio.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/actualidad/')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames =
            webScraper.getElement('div > article > h3 > a', ['href']);
