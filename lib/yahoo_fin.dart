...
class YahooFin extends StatefulWidget {
  const YahooFin({Key? key}) : super(key: key);

  @override
  _YahooFinState createState() => _YahooFinState();
}

class _YahooFinState extends State<YahooFin> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.yahoo.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/news')) {
      setState(() {
