...
class Los40 extends StatefulWidget {
  const Los40({Key? key}) : super(key: key);

  @override
  _Los40State createState() => _Los40State();
}

class _Los40State extends State<Los40> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.los40.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/')) {
      setState(() {
        ...
        productNames = webScraper.getElement('h2.text > a', ['href', 'title']);
