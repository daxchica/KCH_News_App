...
class CiberCuba extends StatefulWidget {
  const CiberCuba({Key? key}) : super(key: key);

  @override
  _CiberCubaState createState() => _CiberCubaState();
}

class _CiberCubaState extends State<CiberCuba> {
  // initialize WebScraper by passing base url of website
  final webScraper = WebScraper('https://www.cibercuba.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage('/entretenimiento')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper.getElement('h3 > a', ['href']);
      ...
      home: Row(
        children: [
          ...
          Flexible(
            ...
            child: Scaffold(
              appBar: AppBar(
                title: const Text('Ciber Cuba Entretenimiento'),
              ),
              body: SafeArea(
